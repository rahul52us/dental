  ...
  const columns = [
    ...
    },
    {
      ...
      metaData: {
        component: (dt: any) => (
          <HStack spacing={2}>
            {stores.auth.hasPermission(dt.workType === 'in-house' ? 'inhouse_lab' : 'outside_lab', 'view') && (
              <IconButton
                size="xs"
                variant="ghost"
                icon={<FiEye />}
            ...
            {stores.auth.hasPermission(dt.workType === 'in-house' ? 'inhouse_lab' : 'outside_lab', 'edit') && (
              <IconButton
                size="xs"
                variant="ghost"
                icon={<FiEdit />}
