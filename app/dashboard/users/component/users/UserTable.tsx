                  ...
                  <Grid templateColumns="repeat(2, 1fr)" gap={4} mt={4}>
                    <GridItem>
                      <Box bg={stores.themeStore.themeConfig.colors.custom.light.primary + "1A"} p={3} borderRadius="lg">
                        ...
                        <Text fontWeight="bold" color={stores.themeStore.themeConfig.colors.custom.light.primary}>{selectedTherapist.profileDetails?.personalInfo?.experience} Years</Text>
                      </Box>
                    </GridItem>
                    <GridItem>
                      <Box bg={stores.themeStore.themeConfig.colors.custom.light.primary + "1A"} p={3} borderRadius="lg">
                        <Text fontSize="sm" color="gray.500">Session Fee</Text>
                        <Text fontWeight="bold" color={stores.themeStore.themeConfig.colors.custom.light.primary}>₹{selectedTherapist.profileDetails?.personalInfo?.charges}</Text>
                      </Box>
                    </GridItem>
                  </Grid>
                </Box>
