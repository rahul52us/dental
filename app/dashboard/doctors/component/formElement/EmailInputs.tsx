...
const EmailsInput = ({ values, setFieldValue, errors, touched }: EmailsInputProps) => {
      ...
      {({ remove, push }) => (
        <Box bg="white" p={4} borderRadius="md" boxShadow="md">
              ...
              {values.emails.map((email, index) => (
                ...
                >
                  ...
                  <CustomInput
                    ...
                    error={errors?.emails?.[index]?.email && touched?.emails?.[index]?.email}
                    showError={errors?.emails?.[index]?.email && touched?.emails?.[index]?.email}
                  />
          ...
          <Button
            ...
            mt={4}
            colorScheme="teal"
            onClick={() => push({ email: "", primary: values.emails.length === 0 })}
          >
            Add Email
          </Button>
        </Box>
