...
const carouselData = [
  {
    imageSrc: "https://res.cloudinary.com/dekfm4tfh/image/upload/v1746613963/8_20250507_155037_0007_zv4yiv.png",
    iconSrc: "/images/contactUs/contactusicon1.svg",
    title: "Our Therapy Rooms",
    description: "Private, confidential, and peaceful!",
  },
  {
    imageSrc: "https://res.cloudinary.com/dekfm4tfh/image/upload/v1746613963/2_20250507_155037_0001_s7pknn.png",
  ...
  {
    imageSrc: "https://res.cloudinary.com/dekfm4tfh/image/upload/v1746613962/1_20250507_155037_0000_dv5yh8.png",
...
const ContactUsFormSection = ({links} : any) => {
  const isMobile = useBreakpointValue({ base: true, lg: false });
  const gridTemplateColumns = useBreakpointValue({
    base: "1fr",
    lg: "1fr 2fr",
  });
  const carouselMaxWidth = useBreakpointValue({ base: "90vw", md:"70vw",lg: "50vw" });
      ...
      <Grid templateColumns={gridTemplateColumns} position="relative" mr={{ lg: 12 }}>
        ...
        <Box position="relative" mr={{ base: 0, md: 0 }} mt={{ base: 6, md: 0 }} order={isMobile ? 1 : 2}>
          ...
          <Box position="relative" zIndex={1} p={formPadding} w={'100%'}>
            <ContactDetailedForm links={links}/>
          </Box>
        </Box>
      </Grid>
    </Box>
