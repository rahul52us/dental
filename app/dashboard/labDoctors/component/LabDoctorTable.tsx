    ...
    <Box>
      <CustomTable
        ...
        actions={{
          actionBtn: {
            addKey: {
              showAddButton: stores.auth.hasPermission('lab_doctors', 'create'),
              function: onAdd,
            },
            editKey: {
              showEditButton: stores.auth.hasPermission('lab_doctors', 'edit'),
              function: onEdit,
            },
            deleteKey: {
              showDeleteButton: stores.auth.hasPermission('lab_doctors', 'delete'),
              function: onDelete,
            },
          },
          search: {
