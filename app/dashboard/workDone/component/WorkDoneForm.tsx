  ...
  const handleSubmit = async (values: any) => {
    ...
    if (!values.status) {
      openNotification({
        ...
        message: "Select the clinical status, it is mandatory.",
      });
      setLoading(false);
      return;
    }
              ...
              <Form onSubmit={formikHandleSubmit}>
                ...
                <VStack align="stretch" spacing={4} pt={4}>
                            ...
                            <Box bg="white" borderRadius="2xl" p={4} border="1px solid" borderColor="blue.100" shadow="sm">
                              <Box w="full">
                                <TeethChart
                                  ...
                                  toothComplaints={{}}
                                  activeComplaintType={values.complaintType || "EXISTING FINDING"}
                  ...
                  <CustomDrawer
                    ...
                    title={
                      <VStack align="start" spacing={0}>
                        <Text fontSize="18px" fontWeight="1000" color="white">Treatment Head</Text>
                      </VStack>
                    }
                    extraActions={
                      <Button
