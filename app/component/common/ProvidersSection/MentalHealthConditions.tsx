...
type ConditionDetails = {
  ...
  pageSlug?: string; // Add pageSlug property to store URL path
};
...
const MentalHealthConditions = () => {
  ...
  const conditionDetails: Record<string, ConditionDetails> = {
    ...
    "Relationship": {
      ...
      // pageSlug: "/condition/relationship"
    },
    "Anger": {
    ...
    "Self-Esteem": {
      ...
      // pageSlug: "/condition/self-esteem"
    },
    "ADHD": {
    ...
    "Autism": {
      ...
      // pageSlug: "/condition/autism"
    },
    "Eating Disorder": {
      description: "Eating disorders are serious mental health condition that affect a person's relationship with food, body image, and self-worth. They can cause extreme eating habits, like eating too little, eating too much, or feeling guilty about food. Eating disorders are not just about food—they are often linked to deeper emotional struggles, but with the right support, recovery is possible.",
      CommonSymptoms: [
      ...
      // pageSlug: "/condition/eating-disorder"
    },
    "Bipolar Disorder": {
      ...
      pageSlug: "/condition/bipolar-disorder"
    }
  };
  ...
  // We'll use Link component for navigation instead of a navigation function
  ...
  return (
    <>
      <Flex mt={{ base: 1, md: 4 }} flexWrap="wrap" justify={{ base: "center", lg: "start" }}>
        {list.map((item) => (
          <Box
            key={item}
      ...
      <Modal isOpen={isOpen} onClose={onClose} isCentered size={{ base: 'sm', md: 'xl' }} scrollBehavior='inside'>
        ...
        <ModalContent borderRadius="xl">
            ...
            {selectedItem && (
              <>
                {conditionDetails[selectedItem]?.description && (
                  <DetailSection title={
                    <Flex align="center">
                      <Image src="/icons/description.svg" alt="Description" width={20} height={20} style={{ marginRight: "8px" }} />
                ...
                {conditionDetails[selectedItem]?.CommonSymptoms?.length > 0 && (
                  <>
                    ...
                    <DetailSection title={
                      <Flex align="center">
                        <Image src="/icons/symptoms.svg" alt="Common Symptoms" width={20} height={20} style={{ marginRight: "8px" }} />
                ...
                {conditionDetails[selectedItem]?.treatmentOptions?.length > 0 && (
                  <>
                    ...
                    <DetailSection title={
                      <Flex align="center">
                        <Image src="/icons/treatment.svg" alt="Treatment Options" width={20} height={20} style={{ marginRight: "8px" }} />
                ...
                {conditionDetails[selectedItem]?.keyStatistics?.length > 0 && (
                  <>
                    ...
                    <DetailSection title={
                      <Flex align="center">
                        <Image src="/icons/statistics.svg" alt="Key Statistics" width={20} height={20} style={{ marginRight: "8px" }} />
          ...
          <ModalFooter>
            {selectedItem && selectedItem !== 'And More..' && conditionDetails[selectedItem]?.pageSlug && (
              <Link href={conditionDetails[selectedItem].pageSlug} passHref onClick={onClose}>
                <Button 
                  as="span"
                  bg="#065F68"
                  color="white"
                  _hover={{ bg: '#054A51' }}
                  // leftIcon={<Image src="/icons/info-circle.svg" alt="Learn More" width={18} height={18} />}
                >
                  Learn More About {selectedItem}
                </Button>
              </Link>
            )}
          </ModalFooter>
